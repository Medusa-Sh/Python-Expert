...
print(f"Type {Fore.YELLOW}help{Fore.CYAN}, {Fore.YELLOW}history{Fore.CYAN}, "
...
while True:
    ...
    if user_input.lower() == "exit":
        ...
        print(f"{Fore.CYAN} You can write exit to quit and search up history{Style.RESET_ALL}")
        continue
